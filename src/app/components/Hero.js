...
export default function Hero() {
  ...
  const roles = ['Data Analytics & Engineering Apprentice', 'Snowflake & SQL Developer', 'Python Automation Enthusiast', 'Data Problem Solver'];
        ...
        <div className={`relative w-full max-w-4xl mx-auto
          ...
          <div className={`transition-all duration-1000 delay-300 
            ...
            >
              ...
              Data Analytics & Engineering Apprentice at Fidelity
            </motion.div>
            ...
            >
              I build data solutions that improve visibility, governance, and decision-making. At Fidelity Business Services India, I work with Snowflake, Python, SQL, Tableau, and enterprise data tools.
            </motion.p>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-8 py-4 text-base font-medium text-slate-700 bg-white border border-slate-200 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-slate-100 flex items-center gap-2"
              >
                View Resume
